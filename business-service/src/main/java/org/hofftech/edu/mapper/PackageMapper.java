...
public interface PackageMapper {
    ...
    /**
     * Преобразует BillingDto в ParsedCommand.
     *
     * @param dto объект BillingDto.
     * @return объект ParsedCommand.
     */
    @Mapping(target = "commandType", constant = "BILLING")
    ParsedCommand toParsedCommand(BillingDto dto);
